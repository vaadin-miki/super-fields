...
public class ScientificNumberFieldTest extends BaseTestsForIntegerNumbers<BigDecimal> {
    ...
    public ScientificNumberFieldTest() {
        super(() -> new ScientificNumberField(new Locale("pl", "PL")),
        ...
        this.invalidInputs("E", "a", "a1", "1:a", "1:E2", "1-e-3", "1,e2-");
    }
