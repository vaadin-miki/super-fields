...
public class SuperIntegerFieldTest extends BaseTestsForIntegerNumbers<Integer> {
  ...
  public SuperIntegerFieldTest() {
    ...
    super(() -> new SuperIntegerField(new Locale.Builder().setLanguage("pl").setRegion("PL").build()), EIGHT_DIGITS, -EIGHT_DIGITS, FORMATTED_EIGHT_DIGITS, NO_GROUPS_FORMATTED_EIGHT_DIGITS, 0);
